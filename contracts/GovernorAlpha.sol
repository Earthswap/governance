...
contract GovernorAlpha {
    ...
    string public constant name = "Earthswap Governor Alpha";
    ...
    /// @notice The address of the Earthswap Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Earthswap governance token
