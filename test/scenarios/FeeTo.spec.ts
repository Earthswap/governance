...
import EarthswapV2Pair from '@earthswap/v2-core/build/EarthswapV2Pair.json'
...
describe('scenario:FeeTo', () => {
  ...
  beforeEach('deploy earthswap v2', async () => {
    factory = await deployContract(wallet, EarthswapV2Factory, [wallet.address])
  })
  ...
  describe('tokens', () => {
    ...
    beforeEach('create fee liquidity', async () => {
      ...
      pair = new Contract(pairAddress, EarthswapV2Pair.abi).connect(wallet)
